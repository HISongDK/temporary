...
function Report() {
  ...
  const handleChangeSearch = (e) => {
    ...
    dispatchParams({
      type: 'text',
      payload: e.target.value.replace("'", '').trim(),
    })
  }
      ...
      title: () => (
        <>
          ...
          >
            <CaretDownOutlined
              style={
                params.mediaType ? { marginLeft: '10px', color: '#1890ff' } : { marginLeft: '10px' }
              }
            />
          </Dropdown>
        </>
      ...
      title: () => (
        <>
          ...
          >
            <CaretDownOutlined
              style={
                params.date ? { marginLeft: '10px', color: '#1890ff' } : { marginLeft: '10px' }
              }
            />
          </Dropdown>
        </>
      ...
      render: (t, r, i) => {
        ...
        return (
          <div className="operate_wrap">
            <span onClick={() => handleClickEdit(t)} className="edit iconfont icon-bi"></span>
            <span
    ...
    <div className="report">
      ...
      >
        ...
        >
          ...
          >
            <Select placeholder="请选择媒体名称" allowClear onChange={handleSelectMedia}>
              {allMedia.map((item) => (
          ...
          <div>
            ...
            <span className="content">
              ...
              {currentMediaData.mediaType &&
                mediaType.filter((item) => item.key === currentMediaData.mediaType)[0]['label']}
            </span>
          </div>
          <div>
